...
PRECISION_MUL: constant(uint256[N_COINS]) = [10000000000, 1, 1, 1]
# PRECISION_MUL: constant(uint256[N_COINS]) = [
#     PRECISION / convert(10 ** 8, uint256),    # wBTC
#     PRECISION / convert(10 ** 18, uint256),   # bcrvRenWBTC
#     PRECISION / convert(10 ** 18, uint256),   # bcrvRenWSBTC
#     PRECISION / convert(10 ** 18, uint256)]   # sBTCcrv
RATES: constant(uint256[N_COINS]) = [10000000000000000000000000000, 1000000000000000000, 1000000000000000000, 1000000000000000000]

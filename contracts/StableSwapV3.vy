...
PRECISION_MUL: constant(uint256[N_COINS]) = [1000000000000, 1000000000000, 1000000000000, 1]
# PRECISION_MUL: constant(uint256[N_COINS]) = [
#     PRECISION / convert(10 ** 6, uint256),  # USDC
#     PRECISION / convert(10 ** 6, uint256),   # FUSDC
#     PRECISION / convert(10 ** 6, uint256),   # FUSDT
#     PRECISION / convert(10 ** 18, uint256)]  # FDAI
RATES: constant(uint256[N_COINS]) = [1000000000000000000000000000000, 1000000000000000000000000000000, 1000000000000000000000000000000, 1000000000000000000]

...
const SWAP_ADDRESS = "0x6b175474e89094c44da98b954eedeac495271d0f";
...
contract("Truffle Mint DAI", async (accounts) => {
  ...
  it("should send DAI to first generated account", async () => {
    ...
    for (const account of accounts.slice(0, 1)) {
      ...
      await daiContract.methods.transfer(account, ether("1").toString()).send({ from: USER_ADDRESS, gasLimit: 800000 });
